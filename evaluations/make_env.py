...
from evaluations.utils import save_videos, summarize_episode
...
def wrap_wrt_track(env, action_repeat, outdir, writer, track, checkpoint_id):
  env = wrappers.OccupancyMapObs(env)
  render_callbacks = []
  render_callbacks.append(lambda videos: save_videos(videos, outdir / 'videos', action_repeat, track, checkpoint_id))
